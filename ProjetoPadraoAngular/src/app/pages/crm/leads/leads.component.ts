...
export class LeadsComponent {
  ...
  // Table data
  leadsList!: Observable<LeadsModel[]>;
  total: Observable<number>;
  @ViewChildren(NgbdLeadsSortableHeader) headers!: QueryList<NgbdLeadsSortableHeader>;

  constructor(private modalService: NgbModal, public service: LeadsService, private formBuilder: UntypedFormBuilder, private offcanvasService: NgbOffcanvas, private datePipe: DatePipe) {
    this.leadsList = service.leads$;
  ...
  */
  saveUser() {
    ...
    //     this.ApiService.patchLeadData(this.leadsForm.value).subscribe(
    //       (data: any) => {
    ...
    //   }
    //   else {
    //     this.ApiService.postContactData(this.leadsForm.value).subscribe(
    //       (data: any) => {
  ...
  */
  editDataGet(id: any, content: any) {
    ...
    // this.ApiService.getSingLeadData(id).subscribe({
    //   next: data => {
