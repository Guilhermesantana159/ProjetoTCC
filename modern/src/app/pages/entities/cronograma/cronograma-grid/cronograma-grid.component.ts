...
@Component({
  selector: 'cronograma-grid-root',
  templateUrl: 'cronograma-grid.component.html',
  styleUrls: ['../cronograma.component.css']
})

export class CronogramaGridComponent{
            ...
            ActionButton: [
              {
                ...
                TypeButton: 1,
                ParametrosAction: {
                  Conteudo: '<i class="ri-calendar-check-line"></i>',
                  ClassProperty: 'btn btn-sm btn-outline-warning waves-effect waves-light',
                  Disabled: {
                    Disabled: undefined,
                    PropertyDisabled: ''
                  },
  ...
  Editar(data: any){
    this.router.navigate(['/main-dashboard/entities/cronograma/' + data.idProjeto.toString()]);
  }
};
