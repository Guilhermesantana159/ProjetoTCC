...
export class OrdersComponent {
  ...
  constructor(private modalService: NgbModal, public service: OrdersService, private formBuilder: UntypedFormBuilder, private datePipe: DatePipe) {
 ...
 */
  ...
  */
  saveUser() {
    ...
    //       (data: any) => {
    //         this.service.products = this.content.map((order: { _id: any; }) => order._id === data.data.ids ? { ...order, ...data.data } : order);
