...
export class CompaniesComponent {
  ...
  constructor(private modalService: NgbModal, public service: CompaniesService, private formBuilder: UntypedFormBuilder) {
  ...
  */
  saveUser() {
    ...
    //     this.ApiService.patchCompanyData(this.companiesForm.value).subscribe(
    //       (data: any) => {
    ...
    //   }
    //   else {
    //     this.ApiService.postCompanyData(this.companiesForm.value).subscribe(
    //       (data: any) => {
...
//  */
//   viewDataGet(id: any) {
//     // this.ApiService.getSingleCompanyData(id).subscribe({
//     //   next: data => {
