...
export class ContactsComponent {
  ...
  constructor(private modalService: NgbModal, public service: ContactsService, private formBuilder: UntypedFormBuilder, private datePipe: DatePipe) {
  ...
  */
  saveUser() {
    ...
    //     this.ApiService.patchContactData(this.contactsForm.value).subscribe(
    //       (data: any) => {
    ...
    //   }
    //   else {
    //     this.ApiService.postContactData(this.contactsForm.value).subscribe(
    //       (data: any) => {
  ...
  */
  viewDataGet(id: any) {
    // this.ApiService.getSingleContactData(id).subscribe({
    //   next: data => {
